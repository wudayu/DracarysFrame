...
public class ProgressWheel extends View {
    ...
    private int innerColor = 0x00FFFFFF;
    ...
    private void setupBounds(int layout_width, int layout_height) {
        ...
        innerCircleBounds = new RectF(paddingLeft + barWidth*3/2,
                paddingTop + barWidth*3/2,
                layout_width - paddingRight - barWidth*3/2,
                layout_height - paddingBottom - barWidth*3/2
        );
    }
    ...
    private void parseAttributes(TypedArray a) {
        ...
        innerColor = a.getColor(R.styleable.ProgressWheel_matProg_innerColor, innerColor);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawArc(innerCircleBounds, 360, 360, false, innerPaint);
